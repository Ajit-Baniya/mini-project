...
<title>Car Rental | Email Verification</title>
<!--Bootstrap -->
    ...
    <div class="row">
      ...
      <div class="col-md-6 col-sm-8">
        <div class="profile_wrap">
          <h5 class="uppercase underline"><?php if ($verified) {
              echo "Your email is verified.";
          } else {?>Verify your email</h5>
          ...
          <form  method="get">
            ...
            <div class="form-group">
              <label class="control-label">Verification Token (<i>see email</i>)</label>
              <input type="text" class="form-control white_bg" name="token" required>
            </div>
          
           
            <div class="form-group">
              <button type="submit" class="btn">Verify Email  <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></button>
            </div>
          </form>
          <?php }?>
        </div>
